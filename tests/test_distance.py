...
@pytest.mark.parametrize("n_jobs,expected_distance_matrix", [
    (1, [[0,  1,  2,  3,  4],
         [1,  0,  5,  6,  7],
         [2,  5,  0,  8,  9],
         [3,  6,  8,  0, 10],
...
def test_precompute_train_distance_everything_selected(x_train_data, train_distance_mixin, n_jobs, expected_distance_matrix):
