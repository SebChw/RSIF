...
def sample_tree():
    ...
    root.left_node = RandomIsolationSimilarityTree(
    ...
    root.right_node = RandomIsolationSimilarityTree(
        "euclidean", depth=1, features_span=[(0, 1), (1, 2), (1, 3)]
    )
...
def broader_tree(sample_tree):
    ...
    sample_tree.left_node.left_node.left_node = RandomIsolationSimilarityTree(
        "euclidean", depth=3, features_span=[(0, 1), (1, 2), (1, 3)]
    )
    sample_tree.left_node.left_node.left_node.is_leaf = True

    sample_tree.left_node.left_node.right_node = RandomIsolationSimilarityTree(
        "euclidean", depth=3, features_span=[(0, 1), (1, 2), (1, 3)]
    )
